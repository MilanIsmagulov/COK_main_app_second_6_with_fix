...
let allQuestions = [
    ...
    {
        type: 1,
        text: 'Какими параметрами определяется выбор оптимальной скорости охлаждения раствора депарафинизата ',
        image: false,
    ...
    },
    {
        type: 1,
        price: 200,
        text: 'Как классифицируются кристаллизаторы по типу создания пересыщения ',
        image: false,
    ...
    {
        type: 1,
        text: 'При каких условиях увеличится выход целевого продукта установок депарафинизации',
        image: false,
